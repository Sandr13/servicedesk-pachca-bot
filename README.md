...
Серверless-обработчик, который позволяет создавать задачи в Yandex Tracker из бота в Pachca, а также обеспечивает двустороннюю связь между Пачкой и Трекером.
